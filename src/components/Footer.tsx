      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li className="text-gray-400">Ghaziabad, India</li>
              <li className="text-gray-400">khushigupta.of@gmail.com</li>
              <li className="text-gray-400">+91 8383015513</li>
            </ul>
          </div>
        </div>
        <div className="border-t border-gray-800 mt-8 pt-8 text-center text-gray-400">
          <p>&copy; Made with ❤️ by Khushi {new Date().getFullYear()} </p>
        </div>
      </div>
    </footer>
  );
